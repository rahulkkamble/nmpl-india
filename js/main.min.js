$(document).ready(function () {
    ...
    function o(o) {
        var d;
        (delta = t ? -120 * o.detail : a ? -o.deltaY : o.wheelDelta),
            1 != e &&
                (delta <= -r &&
                    ((e = !0),
                    n !== i - 1 &&
                        (n++, 
                        (d = $(".page").eq(n - 1)),
                        ($currentSlide = $(".page").removeClass("current").eq(n).addClass("current")),
                        d.removeClass("up-scroll").addClass("down-scroll"),
                        $(".indicate-dots li, .main-menu li").removeClass("current"),
                        $(".indicate-dots li [href='#" + $(".page").eq(n).attr("id") + "'], .main-menu [href='#" + $(".page").eq(n).attr("id") + "']")
                            .parent()
                            .addClass("current")),
                    l(s)),
                delta >= r &&
                    ...
                    (function () {
                        $(".page").eq(n);
                        $(".page").removeClass("current").eq(n).addClass("current").removeClass("down-scroll").addClass("up-scroll"),
                            $(".indicate-dots li, .main-menu li").removeClass("current"),
                            $(".indicate-dots li [href='#" + $(".page").eq(n).attr("id") + "'], .main-menu [href='#" + $(".page").eq(n).attr("id") + "']")
                                .parent()
                                .addClass("current");
            ...
            $("body").addClass("load-withoutscroll"),
                $(".btn[href*='#'], .main-menu a:not(.external)").click(function () {
                    ...
                    return (
                        $("html, body")
                            .stop()
                            .animate({ scrollTop: $(t.attr("href")).offset().top - e }, 750),
                        !1
                    );
                }),
    ...
    $(window).width() > 1023 /* && $(window).height() > 720 */ && (a || (d = !0)),
